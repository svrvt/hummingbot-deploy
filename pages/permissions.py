...
def public_pages():
    return {
        ...
        "Emerald Fund": [
            st.Page("frontend/pages/config/emeraldfund/app_pmm.py", title="PMM", icon="💚", url_path="emeraldfund"),
            st.Page("frontend/pages/config/emeraldfund/app_directional.py", "Directional", icon="💚", url_path="emeraldfund"),
        ],
        "Data": [
